...
class Client {
  ...
  __call(method, params) {
    ...
    const request = new YarRequest(method, params)

    transport.open(this._uri, this._options)
    const header = transport.send(request)
    const response = transport.exec(request)
